...
const NAV_LINKS = [
  ...
  { label: 'Precisión', tab: 'accuracy' },
  { label: 'Tiempos de respuesta', tab: 'latency' },
  { label: 'Repeticiones', tab: 'repetitions' },
  { label: 'Sesiones', tab: 'sessions' },
]
    ...
    <div className="relative min-h-screen overflow-hidden bg-[#f0f0ee]">
      ...
      <div className="relative z-10 flex flex-col min-h-screen">
        <nav className="flex items-center justify-center pt-4 sm:pt-6 px-4 sm:px-8 gap-2 sm:gap-3">
          ...
          <div
            className="flex items-center flex-wrap justify-center gap-3 sm:gap-6 rounded-xl px-4 sm:px-6 py-2.5 sm:py-3"
            style={{ backgroundColor: '#EDEDED' }}
          >
